...
class StorageService {
  ...
  getProgressQuotes(): string[] {
    return [
      ...
      "🏆 Champions are made in the gym, legends in their minds!",
  ...
  getRandomProgressQuote(): string {
    const quotes = this.getProgressQuotes();
